...
lint-py:  ## lint python with ruff
	python -m ruff check airforceone
	python -m ruff format --check airforceone
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix airforceone
	python -m ruff format airforceone
...
test:  ## run python tests
	python -m pytest -v airforceone/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v airforceone/tests --cov=airforceone --cov-report term-missing --cov-report xml
